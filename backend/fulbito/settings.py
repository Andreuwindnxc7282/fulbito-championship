...
ASGI_APPLICATION = 'fulbito.asgi.application'
...
if os.environ.get('USE_POSTGRES', False):
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'fulbito_db'),
...
# Para desarrollo, usar almacenamiento simple
if DEBUG:
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@fulbito.com')
