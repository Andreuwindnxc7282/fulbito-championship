...
export function Schedule() {
  ...
  const loadTeams = async () => {
    try {
      ...
      // Datos de fallback para equipos
      setTeams([
        { id: 1, name: "Real Madrid", coach_name: "Carlo Ancelotti" },
        { id: 2, name: "Manchester City", coach_name: "Pep Guardiola" },
        { id: 3, name: "Arsenal", coach_name: "Mikel Arteta" },
        { id: 4, name: "Inter Miami", coach_name: "Tata Martino" }
      ])
    }
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <TabsContent value="upcoming" className="space-y-4">
          {upcomingMatches.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">Los partidos aparecerán automáticamente cuando el backend cree datos.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {/* Dialog for Edit Match - Simplified for now */}
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Editar Partido</DialogTitle>
            <DialogDescription>
              Funcionalidad de edición de partidos disponible próximamente.
            </DialogDescription>
          </DialogHeader>
